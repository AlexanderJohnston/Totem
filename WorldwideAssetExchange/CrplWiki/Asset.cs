...
namespace CrplWiki
{
    // AssetRoot myDeserializedClass = JsonConvert.DeserializeObject<AssetRoot>(myJsonResponse); 
    ...
    public class Data
    {
        ...
        public string schema_mint { get; set; }
        public string collection_mint { get; set; }
        ...
        public ImmutableData data { get; set; }
    }

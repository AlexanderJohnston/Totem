...
public sealed class ReportListQueryPipeline : IReportListQueryPipeline
{
    readonly ILogger _logger;
    readonly IReadOnlyList<IReportListQueryMiddleware> _steps;
    readonly RuntimeMap _map;

    public ReportListQueryPipeline(ILogger<ReportListQueryPipeline> logger, IReadOnlyList<IReportListQueryMiddleware> steps, RuntimeMap map)
    {
        _logger = logger;
        _steps = steps;
        _map = map;
    ...
    public async Task<IReportListQueryContext<IReportListQuery>> RunAsync(ReportListQueryEnvelope envelope, CancellationToken cancellationToken)
    {

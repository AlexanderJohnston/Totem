...
internal sealed class ObserverGivenMethodBuilder : RuntimeMethodBuilder<ObserverGivenMethod>
{
    internal ObserverGivenMethodBuilder(MethodInfo method) : base(method)
    { }
    ...
    protected override ObserverGivenMethod BuildValue() =>

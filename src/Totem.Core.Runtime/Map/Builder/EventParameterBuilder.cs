...
internal sealed class EventParameterBuilder : RuntimeMethodParameterBuilder<EventParameter>
{
    internal EventParameterBuilder(ParameterInfo parameter) : base(parameter)
    { }
    ...
    internal override void Reflect(RuntimeMapBuilder map)
    {
        ...
        var eventType = isEvent ? type : type.GetImplementedInterfaceGenericArguments(typeof(IEventContext<>)).SingleOrDefault();
